...
assert(html.includes('20260812.6-monkey-100-party-pwa'), '缺少多人桌面版版本标记');
...
assert((await readFile(path.join(projectRoot, 'sw.js'), 'utf8')).includes('myskme-monkey-20260812-6'), '离线缓存版本不匹配');
