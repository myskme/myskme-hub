...
const ROUTES = new Map([
  ...
  ['/vote/board', { origin: UPSTREAMS.leaderboard, upstreamPath: '/vote/board', methods: new Set(['GET']) }],
  ['/vote/cast', { origin: UPSTREAMS.leaderboard, upstreamPath: '/vote/cast', methods: new Set(['POST']) }],
  ['/vote/admin', { origin: UPSTREAMS.leaderboard, upstreamPath: '/vote/admin', methods: new Set(['POST']) }],
