...
## 1. 当前状态（e50dd3c，全部已上线）

- **《灵石远征 GEMFALL》v1 收官**：单文件 `match/index.html`（约 600KB），
  正门 play.myskme.com（EdgeOne，国内可达），github.io 是同一份。
- 这一版收官内容：同伴六人被动全关生效／两阵营（灰塔已砍）／门派满员 6 人／
  90 秒榜+战报／浅色主题「晨光」／月末封榜（只记名不发奖）／
  配速员大修（冲刺与停滞节奏、可偶尔越过榜首、到场天数封顶）。
