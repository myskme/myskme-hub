...
- 2026-08-08 视觉重塑为「暖纸矿彩」：一张 720×1279、16KB 的平整细纸 WebP 统一大厅与弹层，
  只在边缘留下极淡花叶和星盘痕迹；明确不做褶皱、破边、旧污渍与泛黄相框。棋盘仍用深矿槽托住鲜亮灵石，
  周围 HUD、按钮和灵器改成象牙纸、深褐字、铜金、灰玫与鼠尾草绿，按压有短促下沉反馈。
  不使用 `backdrop-filter`、程序噪点或 CSS 无限循环动画，reduced-motion 总让路。主资源现为 55 张 WebP。
- 闯关榜继续只收真实玩家，不恢复配速员；新增「地脉回声」，每天只从真实榜单择取一条里程碑，
  隐去化名与人数且不参与排名，用不透明的他人痕迹替代虚拟人竞争。
